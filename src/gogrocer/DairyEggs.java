 ...
 * @author sarina
 */
public class DairyEggs extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DairyEggs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
